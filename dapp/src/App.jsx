...
function App() {
  ...
  return (
    <div id="content">
      <input type="text" value={value()} /><button type="button" onClick={getMessage}>GetMessge()</button>
      <br />
      <input type="text" value={inputValue()} onInput={handleInputChange} /><button type="button" onClick={setMessage}>SetMessge()</button>
    </div>
  );
}
